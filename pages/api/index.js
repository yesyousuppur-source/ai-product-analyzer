...
// Simple localStorage helpers (replace with Firebase later)
const store = {
...
export default function App() {
  ...
  // ── ANALYZE (calls /api/analyze backend) ──
    ...
    <>
            ...
            {!showPayment ? (
              ...
              <>
                ...
                <div className="payment-box">
                  ...
                  <div className="pay-row"><span>Amount</span><span style={{ color: "#f59e0b" }}>₹149</span></div>
                  <div className="pay-row"><span>Analyses</span><span>30 total</span></div>
                </div>
                <p className="pay-note">⚠️ Replace this button with real Razorpay integration</p>
      ...
      {screen === "dashboard" && (
        <div className="dashboard">
          <nav className="navbar">
            <div className="nav-logo">🧠 <span>APA</span></div>
            <div>
              {usageInfo && (
                <div className="usage-pill">
                  ...
                  {usageInfo.expiry && <span className="expiry-text">· exp {new Date(usageInfo.expiry).toLocaleDateString()}</span>}
                </div>
              )}
            </div>
          ...
          <div className="dash-content">
            <div className="hero">
              ...
              <p className="hero-sub">Enter any product — get deep market analysis, hooks, keywords & more in seconds.</p>
            </div>
            ...
            <div className="input-card">
              ...
              {(user?.plan || "free") === "free" && (
                <p className="free-note">
                  ...
                  <span className="upg-link" onClick={() => setShowPremium(true)}>Upgrade for 30 analyses & no ads →</span>
                </p>
              )}
            </div>
      ...
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .expiry-text { color:#475569; font-size:11px; }
        ...
        .grad-text { background:linear-gradient(135deg,#6366f1,#a855f7,#ec4899); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
        ...
        .analyze-btn { width:100%; background:linear-gradient(135deg,#6366f1 0%,#8b5cf6 50%,#a855f7 100%); border:none; border-radius:14px; padding:15px 0; color:#fff; font-family:'Syne',sans-serif; font-weight:700; font-size:16px; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:8px; box-shadow:0 8px 32px rgba(99,102,241,0.35); transition:transform 0.15s,box-shadow 0.15s; }
        ...
        .premium-btn { width:100%; background:linear-gradient(135deg,#f59e0b,#ef4444); border:none; border-radius:14px; padding:14px 0; color:#fff; font-family:'Syne',sans-serif; font-weight:700; font-size:16px; cursor:pointer; margin-bottom:10px; box-shadow:0 8px 32px rgba(245,158,11,0.3); }
